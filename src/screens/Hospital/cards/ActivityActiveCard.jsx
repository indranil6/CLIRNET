...
class ActivityActiveCard extends React.Component {
    render() {
...
export default ActivityActiveCard;

const ActiveDesktopCard = (props) => (
    <div className={props.customClass + " dskHspltActivitesCard dskHspltActivitesSeaGreen"} onClick={props.cardClick.bind(this, props.cardData)}>
        <div className="full_width radius-6 text-left dskHspltActivitesCardIn">
            ...
            <div className="clearfix"></div>
            <h6 className=" font600 colorBlack font_14px">{props.cardData.total_attachment} Attached   <span className="dskHspltActivitesCondition">{props.cardData.case_condition_name}</span></h6>
            <div className="clearfix"></div>
