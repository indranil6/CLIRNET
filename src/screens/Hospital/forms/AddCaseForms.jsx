...
class AddCaseForms extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            display: false,
        ...
        if (imageUri && this.state.firebase_token != "") {
            ...
            firebase
                ...
                .then(() => {
                    ...
                    const uploadTask =
                        storage.ref(`${AppConfig.imgFolder}${reactLocalStorage
                            .get('@ClirnetStore:user_mem_id', true)}/${filename}`)
                            .put(imageUri)
    ...
    validateFormData() {
        if (!fromDetails.referred_client_master_id ||
            ...
            if (!fromDetails.case_topic) {
                ...
                ToastsStore.error("Enter Full Name");

            } else if (!nameFormat.test(fromDetails.pat_full_name)) {
                ToastsStore.error("Please enter Valid Name")
            } else if (fromDetails.pat_phone_number == null || fromDetails.pat_phone_number == undefined || fromDetails.pat_phone_number == '') {
                ToastsStore.error("Enter Phone Number")

            } else if (!fromDetails.pat_phone_number.match(phoneNoFormat)) {
                ToastsStore.error("Enter a Valid Phone Number")

            } else if (!fromDetails.pat_gender) {
                ToastsStore.error("Please Select Gender")

            } else if (patientCaseFileArr.length <= 0 || prescriptionFileArr.length <= 0) {
                ToastsStore.error("Please Select Atleast 1 file of Patient Consent And Prescription")
            }
            else {
                ...
                <div className="full_width text-left dskHspitalFormLeft_in">
                    <div className="full_width text-left colorWhite dskHspitalFormTtl">
                        <div className="full_width dskHspitalFormTtlIn">
                            <h4 className="font_18px font500">Refer The Case To</h4>
                        ...
                        <div className="full_width dskHspitalFormBody">
                            <Form className="font400 font_14px colorBlack">
                                <Form.Row>
                                            ...
                                            <Form.Group className="col-9">
                                                ...
                                                <div className="full_width dskHspitalFormGndrArea">
                                                    ...
                                                    {(fromDetails.pat_gender == 'Other') ?
                                                        <Form.Check className="dskHspitalFormGndr" checked type="radio" label="Others" name="gender" onClick={this.onGenderChange.bind(this, 'Other')} /> :
                                                        <Form.Check className="dskHspitalFormGndr" type="radio" label="Others" name="gender" onClick={this.onGenderChange.bind(this, 'Other')} />
                                                    }
                                                </div>
                                            </Form.Group>
                                    ...
                                    <Form.Group className="col-sm-6 col-12">
                                        <Form.Label className="font400 font_14px colorBlack">Mobile No.<span className="colorRed">*</span></Form.Label>
                                        <Form.Control type="tel" maxLength="10" placeholder="Patient Mobile Number " value={fromDetails.pat_phone_number} onChange={this.inputBoxChangeHamdler('mobile')} />
                                    </Form.Group>
                                    <Form.Group className="col-sm-6 col-12">
                                        <div className="full_width dskHspitalFormDbl">
                                    ...
                                    <Form.Group className="col-sm-6 col-12 dskHspitalFormFileINBig">
                                        <div className="full_width dskHspitalFormDblFileIN">
                            ...
                            <UpdateProfile 
                            onModalClose={this.onProfileUpdateModalClose.bind(this)}/>
                            :null}
                        </div>
                    </div>
                </div>
