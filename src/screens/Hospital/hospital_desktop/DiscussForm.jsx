...
import CaseDiscussForms from '../forms/CaseDiscussForms.jsx';
...
class DiscussForm extends React.Component {
    ...
    componentDidMount() {
        window.document.title = "CLIRNET - Start a Discussion"
    ...
    render() {
        return (
            <div className="full_width dskScreen">
                ...
                <Banner type_id={this.id} type={"discuss_form"}  apiresponserecieved={this.bannerCallback} api_call_detail={1} api_call={0}/>
                <div className="full_width dskHspitalFormDiscuss">
                    <div className="container mycontainer">
                        <section className="full_width adsArea">
                            ...
                            {this.state.banner_display?<Banner type_id={this.id} banner_position={1} unmount_call={1} type={"discuss_form"} api_call={1} before_unload_call={1} />:null}
                            </div>
                        </section>
                        <div className="row">
                            {
                                (hsProfile.hospital_id) ?
                                    <>
                                        <CaseDiscussForms data="test" history={this.props.history} id={this.id} propfileDetails={hsProfile} operation_type={1} />
                                        {this.state.banner_display?<Banner type_id={this.id} banner_position={2} unmount_call={0} type={"discuss_form"} api_call={1} before_unload_call={0} />:null}
                                    </> :
...
const RecentActivities = (props) => (
    <div className="col-xl-4 col-12 dskHspitalFormRight">
        <div className="full_width dskRightActivities">
            ...
            {props.banner_display_status?<Banner type_id={props.id} banner_position={4} unmount_call={0} type={"discuss_form"} api_call={1} before_unload_call={0} />:null}
        </div>
    </div>
)