...
class PollCard extends React.Component {
  ...
  onPollSubmit(arr_new, options, survey_id, point, i, e) {
    //  e.preventDefault();
          ...
          if (success == 200) {
            ...
            mData.map(function (i) {
              ...
              $(parentDivId).show(500, function () {
                // alert("showing" + resultOpt);
                // document.querySelector(parentDivId).innerHTML = resultOpt  
                $(parentDivId).html(resultOpt);
                // alert("done");
              });
            });
        ...
        >
          ...
          <div className="full_width mblPllsSrvsContent">
            ...
            <div className="full_width srvPollsOptionSet55">
              {currentOptions.map((options, i) => (
                <>
                  {/* {  alert("click"+this.state.checkedRadio+'::'+survey_id + i+"\n"+this.state.checkedRadio.trim() === survey_id + i)  } */}
                  <Form.Check
                    id={"option1" + survey_id + i}
                    className={"srvPollsRadio " + "srvPollsRadio" + survey_id} //srvPollsRadio
                    type="radio"
                    ref={"ref_" + i}
                    ...
                    checked={
                      this.state.checkedRadio
                        ? this.state.checkedRadio === survey_id + i
                        : null
                    }
                  />
                </>
