...
class SurveyCard extends React.Component {
  ...
  surveyCardMenuPopoverDesktop = (val, array_index) => {
    return (
      <div className="dskDotsMenu dskDotsCircle mblDotsMenuPllsQzsCard">
        ...
        <Popover placement="bottom-end" id="popover-basic" className="dskDotsMenuSettings popoverExtra">
          <Popover.Content>
            {/* <a href="javascript:void(0)" className="dskDotsMenuSettingsIcon active" >
              <span>
                <img src={likeIcon} alt="Like"  className="translate_both dskGrLeftShareImg" />
        ...
        <div className="full_width radius-6 mblPllsSrvs_link">
          <div className="full_width mblPllsSrvsPic">
            ...
            <div className="mblPllsSrvsTag">
              <span className="font500 colorWhite font_14px">{(val.category == 'survey') ? 'Survey' : null}</span>
            </div>
            {(this.props.deafult_popover_index == ind) ? this.surveyCardMenuPopoverDesktop(val, ind) : null}
            {(this.props.deafult_popover_index != ind) ?
              <div onClick={this.props.menu_click} className="dskDotsMenu dskDotsCircle mblDotsMenuPllsQzsCard popoverExtra">
                <span className="dskDotsMenu-dots"></span>
                <span className="dskDotsMenu-dots"></span>
                <span className="dskDotsMenu-dots"></span>
              </div> : null}
          ...
          <div className="full_width mblPllsSrvsContent">
            ...
            {(val.survey_title == '' || val.survey_title == null) ? null :
              <h3 className="font400 colorBlack font_16px mblPllsSrvsContentTtl" onClick={this.props.click}>{val.survey_title}</h3>
            }
            <div className="clearfix"></div>
            <h5 className="font400 colorGrey font_14px mblPllsSrvsContentText">{ReactHtmlParser(setDescription(val.survey_description))}</h5>
            <div className="clearfix"></div>
            <div className="full_width mblPllsSrvsbtm">
              <div className="colorWhite font_14px fontExo font700 radius-6 mblPllsSrvsbtm_a" onClick={this.props.click}>
      ...
      <div className="mblPllsSrvsCard mblRecentCard" >
        <div className="full_width radius-6 mblPllsSrvs_link">
          <div className="full_width mblPllsSrvsPic">
            ...
            <div className="mblPllsSrvsTag">
              <span className="font600 colorWhite font_16px">{(val.category == 'survey') ? 'Survey' : null}</span>
            </div>
            {(this.props.deafult_popover_index == ind) ? this.surveyCardMenuPopoverMobile(val, ind) : null}
            {(this.props.deafult_popover_index != ind) ?
              <div onClick={this.props.menu_click} className="mblDotsMenu mblDotsCircle mblDotsMenuPllsQzsCard popoverExtra">
                <span className="mblDotsMenu-dots"></span>
                <span className="mblDotsMenu-dots"></span>
                <span className="mblDotsMenu-dots"></span>
              </div> : null}
          ...
          <div className="full_width mblPllsSrvsContent">
            ...
            <div className="clearfix"></div>
            {(val.survey_title == '' || val.survey_title == null) ? null :
              <h3 className="font500 colorBlack font_18px mblPllsSrvsContentTtl" onClick={this.props.click}>{val.survey_title}</h3>
            }
            <div className="clearfix"></div>
            <h5 className="font400 colorGrey font_14px mblPllsSrvsContentText">{ReactHtmlParser(setDescription(val.survey_description))}</h5>
  ...
  render() {
    return (
      <>
        {(isMobile) ? this.renderMobileCard(this.props) : this.renderDesktopCard(this.props)}
      </>
    );
  }
}
