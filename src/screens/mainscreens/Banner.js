...
import { getAgent } from "../Common/Common.js";
...
class Banner extends React.Component {
        ...
        if (banner_top_type === "image") {
          ...
          if (banner_top_duration == parseInt(top_image_change_time)) {
            ...
            if (banner_top_play_key < banner_top_url_and_redirect.length - 1) {
              ...
              // alert(banner_top_url_and_redirect[banner_top_play_key].url)
              ...
              if (
                ...
                if (
                  ...
                  if (
                    ...
                    var par_url_img = "javascript:void(0)";
                  }

                  $(".banner_href_top").attr("href", par_url_img);
                }
              ...
              if (
                ...
                if (
                  ...
                  if (
                    ...
                    var par_url_b = "javascript:void(0)";
                  }

                  $(".banner_href_bottom").attr("href", par_url_b);
                }
                if (
                  banner_bottom_url_and_redirect[banner_bottom_play_key]
                    .format == "video"
              ...
              if (
                ...
                if (
                  ...
                  if (
                    ...
                    var par_url_image_st = "javascript:void(0)";
                  }

                  $(".banner_href_sidebar_top").attr("href", par_url_image_st);
                }
              ...
              if (
                ...
                if (
                  ...
                  if (
                    ...
                    var par_url_sb = "javascript:void(0)";
                  }

                  $(".banner_href_sidebar_bottom").attr("href", par_url_sb);
                }
  ...
  render() {
    // alert(top_height_val)
    // top_height_val = top_height_val.replace('px','')
    return (
      <>
            ...
            view_top_per == 1 ? (
              ...
              >
                {banner_top_url_and_redirect[banner_top_play_key].url != "" ? ( 
                  <a
                    id="banner_href_top"  
                    className={top_height_val.replace('px','') != 0 && top_height_val.replace('px','') <=100 && isMobile?"banner_href_top leader_board":"banner_href_top"} 
                    target="_blank"
                ...
                >
                  {banner_sidebar_top_url_and_redirect[
                    ...
                    <a
                      ...
                      className="banner_href_sidebar_top"
                      target="__blank"
                      href={
                        banner_sidebar_top_url_and_redirect[
                          banner_sidebar_top_play_key
                ...
                >
                  {banner_sidebar_bottom_url_and_redirect[
                    ...
                    <a
                      ...
                      className="banner_href_sidebar_bottom"
                      target="__blank"
                      href={
                        banner_sidebar_bottom_url_and_redirect[
                          banner_sidebar_bottom_play_key
