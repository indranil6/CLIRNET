 ...
 { 
     ...
     fetch(url+'survey/detail?id='+id, { 
         ...
         responseData.map((r,index) => {
          ...
          this.setState({"survey_question" : dataJson});
        });
                      ...
                      <div className="col-xs-12 masonryBoxFeed">
                          ...
                          <div className="col justify-content-between feedRowTop">
                            <div className="row">
                              <div className="col">
                                ...
                                <span class="font_12px colorBlack font600 feedRow_date ssnDtl_dateDesk"><Moment format="MMMM Do YYYY">{this.state.survey_data[0].publishing_date}</Moment></span>
                                <div className="clearfix"></div>
                                <span class="font_12px colorBlack font600 srvTagTop">{this.makeFirstLaterCapital(this.state.survey_data[0].category)}</span>
                              </div>
                        ...
                        <div className="full_width feedRow_ttl">
                          <div className="full_width">
                            ...
                            {(!this.state.survey_data[0].specialities_name)?null:this.state.survey_data[0].specialities_name.replace(/,/g, ", ")}</span>
                          </div>
                          <a href="javascript:void(0)"  class="font_16px colorBlack font700">{this.state.survey_data[0].survey_title}</a>
                        </div>
                            ...
                            <div className="row align-items-center text-center">
                              <div className="col survey_detailsBtmBox">
                                <h3 className="font_14px font600 colorBlack survey_detailsBtmBoxTtl">
                                  <span className="font_24px font700">{this.state.survey_data[0].question_count}</span>
                                  Questions
                                </h3>
                              </div>
                              <div className="col survey_detailsBtmBox">
                                <h3 className="font_14px font600 colorBlack survey_detailsBtmBoxTtl">
                                  <span className="font_24px font700">{this.state.survey_data[0].survey_time}<small className="font_14px font600"> Mins</small></span>
                                  Duration
                                </h3>
                              </div>
                              <div className="col survey_detailsBtmBox">
                                <h3 className="font_14px font600 colorBlack survey_detailsBtmBoxTtl">
                                  <span className="font_24px font700">{this.state.survey_data[0].survey_points}</span> Points
                                </h3>
                              </div>                   
                            </div>
                          </div>
