...
class CompletedSurveyList extends React.Component { 
    ...
    redirect_to_complete_detail(id){
        this.props.history.push({ 
            pathname: `/SurveyCompletedDetails/` + id + '', 
          })  
    }
                        ...
                        <div className="full_width radius-6 feedRow">
                            <div className="col justify-content-between feedRowTop">
                                ...
                                <div className="col">
                                            ...
                                            <span class="font_12px colorBlack font600 srvTagTop">{this.makeFirstLaterCapital(r.category)}</span>
                                        </div>
                            ...
                            <div class="full_width feedRow_Pic srvRowPic">
                                <a href="javascript:void(0)" onClick={() => { this.redirect_to_survey_detail(r.survey_id); }} ><img className="object_fit_cover" src={r.image}/>
                                    <div className="overlay"></div>
                                    </a>
                                </div> 
                                <div className="full_width feedRow_ttl">
                                    <div className="full_width">
                                        <span class="font_10px radius-6 font600 colorBlue feedRow_speciality">{r.specialities_name.replace(/,/g, ", ")}</span>
                                    </div>
                                    <a href="javascript:void(0)" onClick={() => { this.redirect_to_survey_detail(r.survey_id); }}  class="font_14px colorBlack font700">{r.survey_title}</a>
                                </div>
                           
                            <div className="clearfix"></div>
                            <div class="full_width font_14px feedRow_ans">
                            <p>{r.survey_description.replace('^', ' ')}...<a className="font_14px font600" href="javascript:void(0);" onClick={() => { this.redirect_to_survey_detail(r.survey_id);}}>&nbsp; Read More</a></p>
                            </div>
                            <div className="clearfix"></div>
                    ...
                    <div  className="full_width surveyRightMasonry">
                        ...
                        <Masonry
                            ...
                            {poll_list_data.map((r, index) => (
                             this.renderPoll(r.json_result,r.survey_id)
                            ))}
                        </Masonry>
                        </>
                    </div>:
                 ...
                 <Masonry
                    ...
                    > 
                     {all_list_data.map((r, index) => (
                        <>
                        {(r.category == 'survey' || r.category == 'quiz')?
                        <div className="col-sm-6 col-xs-12 masonryBoxFeed">
                        <div className="full_width radius-6 feedRow">
                            <div className="col justify-content-between feedRowTop">
                                <div className="row">
                    ...
                    </div>:this.renderPoll(r.json_result,r.survey_id) 
                        }  
                        </>
                     ))}                                 
                 </Masonry>
                    ...
                    <Header history={this.props.history}  page_name={pageNames}/>                   
                        <section className="full_width body_area surveyPageFixation">
                            <div className="container">
                                <div className="row">    
                                    <Banner type_id={0} banner_position={1} unmount_call={1} type={"survey"}  api_call={1} before_unload_call={1}/>          
