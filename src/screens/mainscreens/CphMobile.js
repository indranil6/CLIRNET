...
class CphMobile extends React.Component {
					...
					<div className="full_width mblGrDtls">
						...
						<section className="full_width adsArea">
							<div className="full_width adsFrame">
								<Banner type_id={0} type={"cph"} apiresponserecieved={this.display_banner} api_call_detail={1} api_call={0} />
								{(this.state.banner_display == true) ? <Banner type_id={0} banner_position={1} unmount_call={1} type={"cph"} api_call={1} before_unload_call={1} /> : null}
							</div>
						</section>
						{/* Ads------------- */}
...
this.popover_view_spec(r.specialities):null}
									...
									<div className="full_width mblCphTtl">
										...
										<a href="javascript:void(0)" className="mblCphTtlShare" onClick={() => this.share_url(r)}><img src={ShareIcon} />  Share</a>
									</div>
									<div className="clearfix"></div>
							...
							<section className="full_width adsArea">
								<div className="full_width adsFrame">
									{(this.state.banner_display == true) ? <Banner type_id={0} banner_position={2} unmount_call={0} type={"cph"} api_call={1} before_unload_call={0} /> : null}
								</div>
							</section>
							{/* Ads------------- */}
