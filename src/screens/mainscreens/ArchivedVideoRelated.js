...
import ShareDetailPage from '../Common/ShareDetailPage';
...
class ArchivedVideoRelated extends React.Component {
...
handle_change_arc(index, value, type) {
  if (type == 'vault') { 
    ...
    this.setState({ "data_archive": related_video_list })
  }
  if (type == 'like') {
...
export default ArchivedVideoRelated;
