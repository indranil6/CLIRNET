...
class Feeddetailrelated extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    setTimeout(function () {
      ...
      $("table").addClass("table table-bordered font_14px");
      $("table").wrap("<div class='full_width feedRow_ansTable'></div>");
    }, 1000);
      ...
      return (
        <div className="col-sm-12 col-xs-12 masonryBoxFeed">
          <div className="full_width radius-6 feedRow srvPolls">
            <span class="font_12px colorWhite radius-40 text-center font600 float-right srvPollsPoint">
              {point} {this.pointTextValidation(point)}
            </span>
            ...
            <div className="full_width srvPollsOptionSet55">
              ...
              <div
                className="full_width text-center srvPollPowerBy"
  ...
  renderLastPoll(dataJson, survey_id, point) {
    ...
    return (
      <div className="col-sm-12 col-xs-12 masonryBoxFeed">
        <div className="full_width radius-6 feedRow srvPolls">
          <h4 className="font_14px colorBlack font700 srvPollsTtl srvPollsTtlPnt">
            <span class="font_12px colorWhite radius-40 text-center font600 srvPollsPoint">
              {point} {this.pointTextValidation(point)}
            </span>
            <div className="clearfix"></div>
            {question}
...
export default Feeddetailrelated;
