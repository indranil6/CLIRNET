...
class SessionSlider extends React.Component {
    ...
    setJqueryOnCard(length) {
        ...
        $(".mblGrMstrDocRowExtra").each(function (i) {
          if (parseInt($(this).find(".mblGrMstrDocBoxSsn").length) != 1) {
            $(this).find(".mblGrMstrDocBoxSsn").addClass("mblGrMstrDocPopShow");
          }
          else {
            $(this).find(".mblGrMstrDocBoxSsn").removeClass("mblGrMstrDocPopShow");
          }
        });

          $(document).on('click', '.mblGrMstrDocPopShow .mblGrMstrDocBoxIn', function () {
            $('.mblGrMstrDocBoxSsn').removeClass("mblGrMstrDocPopShowActive");
        ...
        $( ".mblGrMstrDocRowExtra" ).each(function( index ) {
            let countcir=$(this).find(".mblGrMstrDocProfileSsn").length; 
             $(this).find(".mblGrMstrDocBoxSsn:nth-child(5)").find(".mblGrMstrDocProfile").remove();
             $(this).find(".mblGrMstrDocBoxSsn:nth-child(5)").find(".mblGrMstrDocBoxInPicSsn").append("<div class='overlay'></div><span id='view-master-doctor' class='mblGrMstrDocCount plus_icon' style='cursor: default;'>+"+(countcir-5)+"</span>");
        });
    ...
    render() {
        return (
            <section className="full_width mblSession">
                                        ...
                                        {(val.session_doctor_entities.length > 0) ?
                                            ...
                                            <div className="mblGrMstrDocBox mblGrMstrDocBoxSsn">
                                                <div className="full_width mblGrMstrDocBoxIn">
                                                    ...
                                                    <div className="radius-6 mblGrMstrDocProfile mblGrMstrDocProfileSsn">
                                                        <img src={val.session_doctor_image} className="object_fit_cover" />
                                                        <div className="overlay"></div>
                ...
                {session_list_data.length <= 0 && !isApiCallDone?<SessionSliderLoader/>:null}
            </section>
        );
    }
}
