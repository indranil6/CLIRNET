                      ...
                      <div className="col-lg-9 col-12 dskLeft">
                        {this.state.data_main.map((r, indexii) => (
                          <section className="full_width text-left dskGrLeftMain">
                            ...
                            <div className="clearfix"></div>
                            {(r.title_video) ? <h1 className="font_16px font300 colorBlack dskMainGrTtl">
                              {r.title_video}
                            </h1> : null}
                            <div className="clearfix"></div>
                        ...
                        {/* {(this.state.data_archive.length > 0) ?
                          <section className="full_width text-left dskGrMoreList dskgrMedwikiList">
                            ...
                            <a  href="javascript:void(0)" onClick={()=>{ this.onViewMoreClick()}} className="text-uppercase colorWhite font_16px fontExo font400 radius-6 mblSessionbtm_a dskGrMoreBtn vanish_class_session_but more_but_switch">
                              <span>View More <img src={angaleWhite} /></span>
                            </a> 
                          </section>:null} */}
                        {/* /////////////Added by sumit/////////////////// */}
                        ...
                        {this.state.association_status != 2 ?
                          ...
                          >
                            {main_data.map((r, indexii) => (
                              <h4 className="font_24px font400 colorBlack dskGrMoreTtl">
                                {(this.state.association_setting && this.state.association_setting.comments) ? this.state.association_setting.comments : 'Comments '}
                                {/* Comments{" "} */}
                                <span className="font_16px">
                                  (
