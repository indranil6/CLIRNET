...
import clirnetLogo from "../../mobImages/logo.png";
import $ from "jquery";
...
class Share extends React.Component {
    ...
    fetch(url + "user/detail", {
      ...
      .then((responseJson) => {
        if (responseJson.status_code == "200") {
          ...
          if (this.props.match.params.type == "gr") {
            if (isMobile) {
              this.props.history.push({
                pathname:
                  "/GrandRoundsMobile/" +
          ...
          if (this.props.match.params.type == "Cph") {
            if (isMobile) {
              this.props.history.push({
                pathname:
                  "/CphMobile/" + this.props.match.params.id + "/social",
              });
            } else {
              this.props.history.push({
                pathname:
          ...
          if (this.props.match.params.type == "archived_video") {
            this.props.history.push({
              pathname:
                "/ArchivedVideo/" + this.props.match.params.id + "/social",
            });
          }

          if (
            this.props.match.params.type != "medwiki" &&
            this.props.match.params.type != "session" &&
            this.props.match.params.type != "survey" &&
            this.props.match.params.type != "gr" &&
            this.props.match.params.type != "Cph" &&
            this.props.match.params.type != "archived_video"
          ) {
            reactLocalStorage.set(
          ...
          if (this.props.match.params.type == "session") {
            ...
            this.props.history.push({
              pathname:
                "/Reservesession/" + this.props.match.params.id + "/social",
            });
          }
            ...
            fetch(url + "survey/detail?id=" + this.props.match.params.id + "", {
              ...
              .then((responseJsons) => {
                if (responseJsons.data[0].category == "poll") {
                  this.props.history.push({
                    pathname:
                      "/PollDetails/" + this.props.match.params.id + "/social",
                  });
                } else {
                  this.props.history.push({
                    pathname:
                      "/SpqDetails/" + this.props.match.params.id + "/social",
                  });
                }
              })
              .catch((error) => {});
          ...
          if (this.props.match.params.type == "medwiki") {
            ...
            fetch(
              ...
              .then((responseJson) => {
                ...
                reactLocalStorage.set(
                  "@ClirnetStore:redirect_url",
                  "/Feeddetail/" + this.props.match.params.id + ""
                );

                this.setState({
                  compendium_view: prev_compendium,
                  share_type: "comp",
                });
          ...
          if (this.props.match.params.type == "gr") {
            ...
            fetch(
              url +
                "openapi/service?type=gr&type_id=" +
                this.props.match.params.id +
                "" +
                extrautm +
                "",
              ...
              .then((response) => response.json())
              .then((responseJson) => {
                prev_gr[0] = responseJson.data;

                if (isMobile) {
                  reactLocalStorage.set(
                    "@ClirnetStore:redirect_url",
                    "/GrandRoundsMobile/" + this.props.match.params.id + ""
                  );
                } else {
                  reactLocalStorage.set(
                    "@ClirnetStore:redirect_url",
                    "/GrandRoundsDesktop/" + this.props.match.params.id + ""
                  );
                }

                let context = this;
                let tempGrAssociation = 1;
                this.setState({ prev_gr: prev_gr[0], share_type: "gr" });
                if (responseJson.data) {
                  tempGrAssociation = responseJson.data[0].association_status;
                }

                //  alert(tempGrAssociation+"///gr After3321//"+this.state.gr_association)
                this.setState({ gr_association: tempGrAssociation });
                if (context.state.prev_gr[0].association_setting) {
                  let tempSetting = JSON.parse(
                    context.state.prev_gr[0].association_setting
                  );
                  context.setState({ gr_association_settings: tempSetting });
                }
                // setTimeout(function () { context.setJqueryOnCard(context.state.prev_gr[0].session_doctor_entities.length) }, 100);

                var len_gr = prev_gr[0][0].description.length;

                per_cpmp = Math.round(len_gr / 5);
          ...
          if (this.props.match.params.type == "Cph") {
            if (isMobile) {
              reactLocalStorage.set("@ClirnetStore:redtype", "CphMobile");
            } else {
              reactLocalStorage.set("@ClirnetStore:redtype", "CphMobile");
            }
            reactLocalStorage.set("@ClirnetStore:redid", 0);
            prev_gr = [];
            var extrautm = "";
            if (
              reactLocalStorage.get("@ClirnetStore:utm_source", "") != "" &&
            ...
            fetch(url + "openapi/service?type=gr&type_id=10" + extrautm + "", {
              method: "GET",
              headers: {
                Authorization: reactLocalStorage.get(
                  "@ClirnetStore:refreshToken",
          ...
          if (this.props.match.params.type == "session") {
            ...
            fetch(
              ...
              .then((responseJson) => {
                ...
                reactLocalStorage.set(
                  "@ClirnetStore:redirect_url",
                  "/Reservesession/" + this.props.match.params.id + ""
                );
          ...
          if (this.props.match.params.type == "archived_video") {
            reactLocalStorage.set("@ClirnetStore:redtype", "ArchivedVideo");
            reactLocalStorage.set(
              "@ClirnetStore:redid",
              this.props.match.params.id
            );
            ...
            fetch(
              url +
                "openapi/service?type=archived_video&type_id=" +
                this.props.match.params.id +
                "" +
                extrautm +
                "",
              ...
              .then((response) => response.json())
              .then((responseJson) => {
                prev_video[0] = responseJson.data;

                reactLocalStorage.set(
                  "@ClirnetStore:redirect_url",
                  "/ArchivedVideo/" + this.props.match.params.id + ""
                );

                this.setState({
                  prev_video: prev_video,
                  share_type: "archived_video",
                });
              });
          }
          ...
          if (this.props.match.params.type == "survey") {
            ...
            fetch(
              url +
                "openapi/service?type=survey&type_id=" +
                this.props.match.params.id +
                "" +
                extrautm +
                "",
              ...
              .then((responseJson) => {
                ...
                if (responseJson.data.category == "poll") {
                  ...
                  reactLocalStorage.set(
                    "@ClirnetStore:redirect_url",
                    "/PollDetails/" + this.props.match.params.id + ""
                  );
                } else {
                  reactLocalStorage.set("@ClirnetStore:redtype", "SpqDetails");
                }
  ...
  componentDidMount() {
    window.document.title = "CLIRNET - Share";
  ...
  otp_send_or_login_password() {
    ...
    if (this.state.login_type == 1) {
      ...
      gtag("config", AppConfig.gtag_measure_id, {
        page_title: "SHARE_LOGIN_PASSWORD",
        page_location: window.location.href,
        page_path: window.location.pathname,
      });
                    ...
                    if (responseJson.status_code == "200") {
                      ...
                      if (
                        reactLocalStorage.get("@ClirnetStore:redtype", true) !=
                          "" &&
                        reactLocalStorage.get("@ClirnetStore:redid", 0) != "" &&
                        reactLocalStorage.get("@ClirnetStore:redtype", true) !=
                          true &&
                        reactLocalStorage.get("@ClirnetStore:redid", 0) != 0
                      ) {
                        this.props.history.push({
                          pathname:
                            "/" +
      ...
      <div>
        {this.state.display == 1 ? (
          <div>
            {this.state.compendium_view.map((r, index) => (
              <Helmet>
                ...
                <meta
                  name="twitter:title"
                  content={
                    r.question + "|  CLIRNet eConnect  | Powered by CLIRNet"
                  }
                />
            ...
            {this.state.prev_gr.map((r, index) => (
              <Helmet>
                <meta
                  property="og:url"
                  content={
                    "https://doctor.clirnet.com/services/#/share/gr/" +
                    r.type_id
                  }
                />
                <meta property="og:type" content="article" />
                ...
                <meta
                  property="og:description"
                  content={r.description.substr(0, 100)}
                />
                <meta property="og:image" content={r.image} />
                <meta property="og:image:secure_url" content={r.image} />
                <meta name="twitter:image" content={r.image} />
                <meta
                  name="twitter:title"
                  content={
                    r.title + "|  CLIRNet eConnect  | Powered by CLIRNet"
                  }
                />
                <meta name="twitter:card" content="summary_large_image" />
              </Helmet>
            ...
            {this.state.prev_survey.map((r, index) => (
              <Helmet>
                <meta
                  property="og:url"
                  content={
                    "https://doctor.clirnet.com/services/#/share/survey/" +
                    r.type_id
                  }
                />
                <meta property="og:type" content="article" />
                ...
                <meta
                  property="og:description"
                  content={r.survey_description.substr(0, 100)}
                />
                <meta property="og:image" content={r.image} />
                <meta property="og:image:secure_url" content={r.image} />
                <meta name="twitter:image" content={r.image} />
                <meta
                  name="twitter:title"
                  content={
                    r.survey_title + "|  CLIRNet eConnect  | Powered by CLIRNet"
                  }
                />
                <meta name="twitter:card" content="summary_large_image" />
              </Helmet>
            ...
            {this.state.prev_video.map((r, index) => (
              <Helmet>
                <meta
                  property="og:url"
                  content={
                    "https://doctor.clirnet.com/services/#/share/archived_video/" +
                    r.type_id
                  }
                />
                <meta property="og:type" content="article" />
                <meta
                  property="og:title"
                  content={ReactHtmlParser(r.question)}
                />
                <meta
                  property="og:description"
                  content={ReactHtmlParser(r.answer.substr(0, 100))}
                />
                <meta property="og:image" content={r.image} />
                <meta property="og:image:secure_url" content={r.image} />
                <meta name="twitter:image" content={r.image} />
                <meta
                  name="twitter:title"
                  content={
                    ReactHtmlParser(r.question) +
                    "|  CLIRNet eConnect  | Powered by CLIRNet"
                  }
                />
                <meta name="twitter:card" content="summary_large_image" />
              </Helmet>
            ...
            {this.state.prev_session.map((rses, index) => (
              <Helmet>
                <meta
                  property="og:url"
                  content={
                    "https://doctor.clirnet.com/services/#/share/session/" +
                    rses[0].session_id
                  }
                />
                <meta property="og:type" content="article" />
                ...
                <meta
                  property="og:description"
                  content={rses[0].session_topic}
                />
                {rses[0].session_doctor_entities.map((docres) => (
                  <meta
                    property="og:image"
                    content={docres.session_doctor_image}
                  />
                ))}
                {rses[0].session_doctor_entities.map((docres) => (
                  <meta
            ...
            <section className="full_width l_main_body sharePageMain">
              <div className="l_mainBox">
                <div
                  className="l_frmPart "
                  onKeyDown={this._handleKeyDownshare}
                >
                  ...
                  <div className="full_width l_rightIn">
                    ...
                    >
                      <div className="row align-items-center">
                        <div className="col">
                          {this.state.gr_association == 1 ? null : (
                            <div className="full_width text-center dskAsst_grDocLogo">
                              <div className="dskAsst_grDocLogoIn">
                                {this.state.prev_gr.length > 0 &&
                                this.state.prev_gr[0].sponsor_logo ? (
                                  <>
                                    {this.state.prev_gr[0].sponsor_logo
                                      .split(",")
                                      .map((val, ind) =>
                        ...
                        <a className="colorWhite font600 l_form_forgot" href="javascript:void(0)">Forgot Password ?</a>
                            ...
                            {this.state.gr_association == "1" ? (
                              ...
                              <div className="full_width text-center sharepageClirnetLogo">
                                <span className="font_14px font500 colorWhite">
                                  Powered by
                                </span>
                                <img
                                  src={clirnetLogo}
                    ...
                    <div className="full_width text-left l_medwiki_Body">
                      ...
                      >
                        ...
                        <div className="font500 full_width l_medwiki_content">
                          ...
                          {this.state.gr_association != "1" ? (
                            <div className="full_width text-left radius-6 dskAsst_grDocMain">
                              <h4 className="font600 fontExo font_20px colorBlack text-uppercase dskAsst_grDocTtl">
                                {this.state.gr_association_settings &&
                                this.state.gr_association_settings.master_doctor
                                  ? this.state.gr_association_settings
                                      .master_doctor
                                  : " MasterDoctor"}
                              </h4>
                              <div className="clearfix"></div>
                              <div className="full_width dskAsst_grDocArea">
                                <div className="row">
                                  {this.state.prev_gr[0]
                                    .session_doctor_entities &&
                                  this.state.prev_gr[0].session_doctor_entities
                                    .length > 0 ? (
                                    <>
                                      {this.state.prev_gr[0].session_doctor_entities.map(
                                        (rdoctor, indexdoctor) => (
                                          <div className="col-md-4 col-sm-3 col-12 dskAsst_grDocBox">
                                            <div className="full_width dskAsst_grDocBoxIn">
                                              <div className="radius-100 dskAsst_grDocBoxInPic">
                                                {rdoctor.session_doctor_image ? (
                                                  <img
                                                    src={
                                                      rdoctor.session_doctor_image
                                                    }
                                              ...
                                              <div className="font_12px colorGrey font400 dskAsst_grDocBoxContent">
                                                <h4 className="font_14px colorBlack font600">
                                                  {rdoctor.session_doctor_name}
                                                </h4>
                                                {rdoctor.subtitle ? (
                                                  <h5 className="font_12px colorBlack font500">
                                                    {rdoctor.subtitle}
                                                  </h5>
                                                ) : null}
                                  ...
                                  {/* <div className="col-md-4 col-sm-3 col-12 dskAsst_grDocBox">
                                    <div className="full_width dskAsst_grDocBoxIn">
                                      <div className="radius-100 dskAsst_grDocBoxInPic">
                                        <img
                                          src="https://i.pinimg.com/564x/a5/b2/6b/a5b26b335cc94272b7c1878ec5b13dbd.jpg" className="object_fit_cover"
                                        />
                                      </div>
                                      <div className="font_12px colorGrey font400 dskAsst_grDocBoxContent">
                                        <h4 className="font_16px colorBlack font600">
                                          Doctor Name
                                        </h4>
                                        <h5 className="font_14px colorBlack font500">Doctor degree</h5>
                                        <p>Doctor description gose here Doctor description gose here</p>
                                      </div>
                                    </div>
                                  </div> */}
                                </div>
                            ...
                            {this.state.prev_gr[0].session_doctor_entities && this.state.prev_gr[0].session_doctor_entities.length>0?
                            <>
                              {this.state.prev_gr[0].session_doctor_entities.map(
                                (rdoctor, indexdoctor) => (
                  ...
                  <div className="l_leftBox l_medWiki_left">
                    ...
                    <div className="full_width text-left l_medwiki_Body">
                      <Scrollbars
                        ...
                        style={{ width: "100%", height: "100%" }}
                      >
                        {rsuv.specialities_name != "" &&
                        rsuv.specialities_name != undefined &&
                        rsuv.specialities_name != null ? (
                          <h4 className="font_16px font700 colorBlack l_medWiki_spec">
                            <span class="font_20px colorBlue">[</span>{" "}
                            {rsuv.specialities_name}{" "}
                            <span className="font_20px colorBlue">]</span>
                        ...
                        <div className="font500 full_width l_medwiki_content">
                          <p>
                            {ReactHtmlParser(rsuv.survey_description)}
                            <span style={{ color: "#38b49b" }}>
                              <a
                                href="javascript:void(0)"
                                onClick={() => {
                ...
                this.props.match.params.type != "archived_video" ? (
                  <div className="l_leftBox l_session_left">
                    <img
                      src={logiInLeft}
                      className="loginGrap translate_both"
                    />
                  </div>
                ) : null}
              </div>
