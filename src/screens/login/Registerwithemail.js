...
class Registerwithemail extends React.Component {
  ...
  componentDidMount() {
    ...
    console.log("New Code Again By Dev");
    this.isHaveReferalCode();
  ...
  registration() {
    ...
    if (
      ...
      has_error = 1;
      this.setState({ err_msg: "Please enter Password And Confirm Password" });
      this.setState({ is_loader: false });
    } else {
      if (this.state.password.trim() != this.state.confirm_password.trim()) {
        has_error = 1;
        this.setState({ err_msg: "Password And Confirm Password Mismatch" });
        this.setState({ is_loader: false });
      }
    }
    ...
    if (has_error == 0) {
      ...
      let data = {
        ...
        age: this.state.age,
        referal_code: this.state.referal,
        user_type: this.state.usertype,
        speciality: speciality_val,
        honarific: this.state.honarific,
              ...
              .then((responseJson) => {
                if (responseJson.status_code == "200") {
                  ...
                  if (
                    ...
                    if (
                      reactLocalStorage.get("@ClirnetStore:deals_url", true) !=
                        "" &&
                      reactLocalStorage.get("@ClirnetStore:deals_url", true) !=
                        true &&
                      reactLocalStorage.get("@ClirnetStore:email", 0) != 0 &&
                      reactLocalStorage.get("@ClirnetStore:email", 0) != "" &&
                      reactLocalStorage.get("@ClirnetStore:email", 0) !=
                        undefined &&
                      reactLocalStorage.get("@ClirnetStore:email", 0) != null &&
                      reactLocalStorage.get("@ClirnetStore:email", 0) !=
                        "undefined"
                    ) {
                    ...
                    <div className="col">
                      ...
                      <div className="full_width l_frmBody">
                        <div className="full_width mobleNoCont">
                          <select
                            onChange={this.handleChange("honarific")}
...
<option value="6">Not a Healthcare Professional</option>
                        ...
                        <div className="full_width l_form_row l_regFrmRowEffct l_regFormRowWtoHvr regRowCount">
                          ...
                          <input
                            ...
                            onChange={this.handleChange("referal")}
