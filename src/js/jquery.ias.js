    ...
    $.ias = function (options)
    {
        ...
        function loadItems(url, onCompleteHandler, delay)
        {
            ...
            $.get(url, null, function (data) {
				...
				//container = $($.parseHTML(data, document, true)).find('<script>');
				
				
				//alert($(container).clone().wrap('<div/>').parent().html());
                ...
                if (container) {
                    container.find(opts.item).each(function () {
						...
						//alert(items);
						//alert($(items).clone().wrap('<div/>').parent().html());
